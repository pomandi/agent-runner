...
def load_credentials() -> dict:
    ...
    env_mappings = [
        ('SHOPIFY_ACCESS_TOKEN', ['SHOPIFY_ACCESS_TOKEN_POMANDI', 'SHOPIFY_ACCESS_TOKEN']),
        ('SHOPIFY_STORE_NAME', ['SHOPIFY_STORE_NAME_POMANDI', 'SHOPIFY_STORE_NAME']),
    ]
    ...
    if not credentials.get('SHOPIFY_ACCESS_TOKEN'):
    ...
    print(f"[SHOPIFY] Loaded credentials: {loaded_keys}", file=sys.stderr)
